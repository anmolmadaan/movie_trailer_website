...
# An object is created named transformers to store the details of movie transformers
transformers = media.Movie("Transformers",
                           "Several thousand years ago,"
                           "the planet Cybertron was consumed by a"
                           " civil war by the two Transformer factions,"
